...
//    case theme5 = "empty card 3"
    ...
    static let allAssets: [String:[String:String]] = [
        "zoo":["background":"mini zoo card", "startButton":"start button", "label":"mini zoo"],
        "forest":["background":"empty card", "startButton":"start button", "label":"mini zoo"],
        "garden":["background":"empty card 1", "startButton":"start button", "label":"mini zoo"],

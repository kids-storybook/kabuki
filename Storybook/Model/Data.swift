...
let initThemeData: [ThemeModel] = [
    ThemeModel(background: "mini zoo theme", mapBackground: "zoo_background", name: "zoo", isActive: true, challenges: [
        ChallangeModel(background: "bright_elephant_cage", challengeName: "elephant_challenge", isActive: false, xCoordinate: -545.187, yCoordinate: 165.877, zPosition: 1.0, gameBackground: "elephant_shape_background", level: AttributeLevel.medium, nextChallenge: "panda_challenge"),
        ...
        ChallangeModel(background: "bright_panda_cage", challengeName: "panda_challenge", isActive: false, xCoordinate: -217.127, yCoordinate: 419.343, zPosition: 1.0, gameBackground: "panda_shape_background", level: AttributeLevel.hard, nextChallenge: "elephant_challenge"),

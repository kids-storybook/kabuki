...
struct ShapeModel {
    ...
    var background: String?
    var order: Int32
    // characterAtlas, xPositionCharacter, yPositionCharacter
}
...
let initAssessmentData: [StoryModel] = [
    StoryModel(challengeName: "lion_challenge", title: "singaStoryTitle", labels: ["Lihatlah keluarga singa ini"], labelColor: StoryLabelColor.green, order: 0, background: "kandangSinga", character: "lions_1", characterAtlas: "LionStoryAnimation", characterXPosition: 0, characterYPosition: -80),
    StoryModel(challengeName: "lion_challenge", title: "singaStoryTitle", labels: ["Ada Bapak singa, Ibu singa, dan", "anak singa"], labelColor: StoryLabelColor.green, order: 1, background: "kandangSinga", character: "lions_1", characterAtlas: "LionStoryAnimation", characterXPosition: 0, characterYPosition: -80),
    StoryModel(challengeName: "lion_challenge_animate", title: "singaStoryTitle", labels: ["Ibu Singa memberikan anaknya", "berbagai bentuk mainan"], labelColor: StoryLabelColor.green, order: 0, background: "kandangSingaZoom", character: "lions_2", characterAtlas: "LionShapesAnimation", characterXPosition: -130, characterYPosition: -75),
    StoryModel(challengeName: "lion_challenge_animate_2", title: "singaStoryTitle", labels: ["Ada yang berbentuk persegi,", "segitiga, dan lingkaran"], labelColor: StoryLabelColor.green, order: 0, background: "kandangSingaZoom", character: "lions_2", characterAtlas: "LionShapesAnimation", characterXPosition: -130, characterYPosition: -75),
    StoryModel(challengeName: "lion_challenge_appreciation", title: "berhasilTitle", labels: ["appreciate"], labelColor: StoryLabelColor.green, order: 0, background: "kandangSinga", character: "lion_appreciation", characterAtlas: "LionAppreciationAnimation", characterXPosition: 30, characterYPosition: -100),
...
let initShapeData: [ShapeModel] = [
    ...
    ShapeModel(challengeName: "panda_challenge", background: "panda_circle_2_1", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_circle_2_2", order: 1),
    
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_1", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_2", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_3", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_4", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_5", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_6", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_2_7", order: 1),
    
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_2_1", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_2_2", order: 1),
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_2_3", order: 1),
    
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_1_1", order: 0),
    ShapeModel(challengeName: "panda_challenge", background: "panda_square_1_2", order: 0),

    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_1_1", order: 0),
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_1_2", order: 0),
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_1_4", order: 0),
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_1_5", order: 0),
    ShapeModel(challengeName: "panda_challenge", background: "panda_triangle_1_3", order: 0),
]
